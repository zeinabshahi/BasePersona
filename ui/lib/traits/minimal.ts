...
/** پالت ساده‌ی پاستل برای هر species – لوکال، بدون وابستگی به ../species */
const SPECIES_PASTELS: Partial<Record<SpeciesId, string>> = {
  owl: '#E6F0FF',
  fox: '#FFEAE2',
  whale: '#E2F4FF',
  panda: '#F5F5F5',
...
export function selectTraitsLite(m: TraitMetricsLite): TraitSelectionLite {
  ...
  const pastelHex = SPECIES_PASTELS[sp] || '#E6F0FF';
